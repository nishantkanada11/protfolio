...
const AboutContent = () => {
  return (
    ...
    >
      ...
      {/* Heading */}
      <h2 className="mt-6 text-5xl font-black leading-tight text-zinc-900 dark:text-white">
        Building Digital
      ...
      <p className="mt-8 text-lg leading-8 text-zinc-600 dark:text-zinc-300">
        ...
        high-performance web applications. My experience includes
        building solutions using React, Laravel, PHP, WordPress
        and MySQL while collaborating with development teams on
      ...
      <div className="mt-12 flex flex-wrap gap-4">
        <Button
          ...
          onClick={() => {
            ...
            link.href = "/images/Nishant_Kanada.pdf";
            link.download = "Nishant_Kanada_Resume.pdf";
            link.click();
          }}
        >
          Download Resume
